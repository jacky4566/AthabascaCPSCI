...
public class PathFinding {
     ...
     * finish
     */
    public static List<Direction> findPath(short[][] levelData, int startX, int startY, int goalX, int goalY) {
        ...
        while (!openSet.isEmpty()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (neighborX >= 0 && neighborX < width && neighborY >= 0 && neighborY < height
                        && levelData[neighborX][neighborY] != 1 && !visited[neighborX][neighborY]) {
     ...
     * Manhattan is faster to calculate than using pythag float point math. Typically overkill for 2D grids.
     */
     ...
     */
    public static int getCost(short terrainType) {
